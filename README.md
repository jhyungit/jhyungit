...
| 💼 **경험** | 기업은행 IT그룹 청년인턴 (우수인턴) · 달리셔스 기업연계 프로젝트(우수상) |
...
### 📊 MLB 연봉 예측 프로젝트
> 머신러닝 회귀 모델을 활용한 MLB 선수 연봉 예측

- Linear Regression / RandomForest 모델 비교 분석
- 데이터 전처리 및 시각화 수행

🔗 [GitHub Repository](https://github.com/jhyungit/ML_baseball_project)
