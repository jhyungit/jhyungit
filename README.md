...
| 시기 | 수상 | 주관 |
|:---|:---|:---|
| **2026.08** | **SSAFY 2학기 공통 프로젝트 최우수상** <br/><sub>1등 · 실시간 웹 파티게임 YORR · 6인 팀 팀장/PM</sub> | 삼성전자 · 고용노동부 |
| **2026.06** | **SSAFY 1학기 관통 프로젝트 우수상** <br/><sub>2등 · 여행 협업 플랫폼 EnjoyTrip · 2인 팀 팀장/백엔드</sub> | 삼성전자 · 고용노동부 |
...
> Spring Boot 기반 협업 서비스 · 2인 팀 · **SSAFY 관통 프로젝트 우수상 (2등)** · AWS 배포 운영 중 <sub>(상장·수료 증명서상 명칭 EnjoyTrip)</sub>
