...
| 🏆 **수상** | SSAFY 공통 프로젝트 우수상(서울 4반 1등) · SSAFY 관통 프로젝트 우수상(서울 11반 2등) · IBK 우수팀·우수인턴 · ASAC 과정 우수상(6팀 중 1위) |
| 🌏 **해외** | 호주 워킹홀리데이 11개월 · ILSC Sydney 어학연수 17주 (Intermediate → Advanced 수료, 우수 학생 선정) · 현지 레스토랑 근무 |
